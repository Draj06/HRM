...
const Payroll = () => {
  ...
  if (error || errorR || errorI || errorS || errorY)
    ...
    let result = dataI.getInitialPayroleLatestMonthAndYearData || data.getEmpPayroleByMonthYear;
  const filterData = () => {
      ...
      <div className="container-fluid emp_Container">
        <div className="row">
          <div className="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
            <h5 className="headingEmploye">Payroll</h5>
          </div>
        </div>
        <hr></hr>
        <div className="row">
          <div
            className="col-12 col-sm-12 col-md-8 col-lg-9 col-xl-10"
            align="center"
          >
            <div className="container-fluid">
              <div className="alert alert-danger alert-dismissible">
                <div>
                  <strong>
                    {" "}
                    No Data for Selected Year-Month : {year} {month} . Click to
                    go back :{" "}
                  </strong>
                ...
                <div className="row statbar col-lg-12">
                  ...
                  >
                    ...
                    <span className="statbadge badge-pill primary ml-2">
                      {(StatData.count).toLocaleString("en-IN")}
                    </span>
                  </button>
                  <button
                    type="button"
                  ...
                  >
                    ...
                    <span className="statbadge badge-pill primary ml-2">
                      {(StatData.emp_total_ctc).toLocaleString("en-IN")}
                    </span>
                  </button>
                  <button
                    type="button"
                  ...
                  >
                    ...
                    <span className="statbadge badge-pill primary ml-2">
                      {(StatData.emp_total_gross_salary).toLocaleString("en-IN")}
                    </span>
                  </button>
