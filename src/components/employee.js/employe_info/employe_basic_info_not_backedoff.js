...
const Employe_basic_info_not_backedoff = (props) => {
  ...
  useEffect(() => {
    if (data) {
      let status ={status:localStorage.getItem('emp_status')}
      console.log(status)
      let d = data.getEmpBasicInfo
        ...
        <div className="emp_sideLeft">
          ...
          <div className="row">
            ...
            <div className="form-group col-6 col-sm-6 col-md-6 col-lg-4 col-xl-4">
             ...
             <div className="form-group col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4">
            <BackedOffTog trigerToggle={backedOftoggle} state="false"/>
            </div>
            }
...
export default Employe_basic_info_not_backedoff;
